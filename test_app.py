...
class TestURLShortenerApp(unittest.TestCase):
    ...
    def test_get_all_keys(self):
        ...
        test_url = {"url": "https://www.example.com"}
        self.client.post('/', json=test_url)
    ...
    def test_delete_url(self):
        ...
        # Check if the test URL is removed from the url_data dictionary
        self.assertNotIn(unique_id, self.url_shortener_app.url_data)
